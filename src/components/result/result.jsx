                        ...
                        <div className="row">
                            <div className="ResultCard-Container">
                                ...
                                <div className="ResultMain-Card">
                                    ...
                                    <span className="Resultdot"><h1></h1>
     <h5 className="ResultTot-Num resulth5"></h5></span>
                                    ...
                                    <div className="ResultSummary">
                                        {data?.map((value, index) => (
                                            <div className="ResultReaction" key={index}>
                                                ...
                                                <p className="ResultReac-Score"> <span
                                                    className="ResultOutof">{value}</span></p>
                                        ...
                                        <div className="ResultContinue-BTN mb-4">
                                            ...
                                            <p className="ResultContinue">Home</p></Link>
                                    </div>
                                </div>
                                </div>
                            </div>
